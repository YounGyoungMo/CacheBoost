...
## 개요
CacheBoost는 도서 검색 및 인기 검색어 랭킹 조회 프로젝트입니다.

실제 상용 서비스인 Yes24를 벤치마킹하여,
JWT 기반 로그인, 검색 기능 캐싱, 인기 키워드 집계 및 조회 등
성능 최적화와 캐시 활용에 중점을 두고 개발하였습니다.

복잡한 기능보다는 **핵심 기능을 간결하게 구현**하는 데 집중한 프로젝트입니다.  
실제 상용 서비스인 **Yes24**를 벤치마킹하여, **검색 성능 향상과 인기 키워드 캐싱**에 중점을 두고 설계하였습니다.
